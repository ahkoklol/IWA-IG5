      ...
      >
        ...
        <View style={styles.headerWrapper}>
          <View style={styles.header}>
            ...
            <Text style={styles.headerTitle}>{t("profile_transactions")}</Text>
        ...
        <View style={styles.content}>
          {transactions.length === 0 ? (
            <View style={styles.emptyState}>
              <Text style={styles.emptyText}>{t("transactions_empty")}</Text>
            </View>
          ) : (
                    ...
                    {isCompleted && (
                      <View style={styles.reviewButtonContainer}>
                        ...
                        >
                          ...
                          >
                            {transaction.reviewed
                              ? t("status_seller_already_reviewed")
                              : t("common_review_seller")}
                          </Text>
                        </TouchableOpacity>
                      </View>
                    )}
